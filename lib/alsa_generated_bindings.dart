...
typedef snd_local_error_handler_t = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int, ffi.Pointer<ffi.Char>,
            ffi.Int, ffi.Pointer<ffi.Char>, ffi.Pointer<_va_list_tag_>)>>;
...
class snd_pcm_audio_tstamp_config_ extends ffi.Opaque {}

class snd_pcm_audio_tstamp_report_ extends ffi.Opaque {}
...
class snd_pcm_channel_area_ extends ffi.Struct {
...
class _snd_pcm_sync_id extends ffi.Union {
  @ffi.Array.multi([16])
...
class snd_pcm_chmap extends ffi.Struct {
  @ffi.UnsignedInt()
  external int channels;

  @ffi.Array.multi([0])
  external ffi.Array<ffi.UnsignedInt> pos;
}

class snd_pcm_chmap_query extends ffi.Struct {
  @ffi.Int32()
  external int type;
...
typedef snd_pcm_hook_func_t = ffi
    .Pointer<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<snd_pcm_hook_t>)>>;

class snd_pcm_scope_ops_ extends ffi.Struct {
  external ffi.Pointer<
          ffi.NativeFunction<ffi.Int Function(ffi.Pointer<snd_pcm_scope_t>)>>
      enable;
...
class snd_timer_read_ extends ffi.Struct {
  @ffi.UnsignedInt()
...
class snd_timer_tread_ extends ffi.Struct {
  @ffi.Int32()
  external int event;
...
class snd_aes_iec958 extends ffi.Struct {
  @ffi.Array.multi([24])
...
typedef snd_hctl_elem_callback_t = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int Function(ffi.Pointer<snd_hctl_elem_t>, ffi.UnsignedInt)>>;
...
typedef snd_mixer_compare_t = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int Function(
            ffi.Pointer<snd_mixer_elem_t>, ffi.Pointer<snd_mixer_elem_t>)>>;
typedef snd_mixer_callback_t = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int Function(ffi.Pointer<snd_mixer_t>, ffi.UnsignedInt,
            ffi.Pointer<snd_mixer_elem_t>)>>;
typedef snd_mixer_class_t = snd_mixer_class_;
typedef snd_mixer_elem_callback_t = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int Function(ffi.Pointer<snd_mixer_elem_t>, ffi.UnsignedInt)>>;
typedef snd_mixer_event_t = ffi.Pointer<
    ffi.NativeFunction<
        ffi.Int Function(ffi.Pointer<snd_mixer_class_t>, ffi.UnsignedInt,
            ffi.Pointer<snd_hctl_elem_t>, ffi.Pointer<snd_mixer_elem_t>)>>;
...
class snd_seq_addr extends ffi.Struct {
  @ffi.UnsignedChar()
  external int client;
...
class snd_seq_connect extends ffi.Struct {
...
class snd_seq_real_time extends ffi.Struct {
  @ffi.UnsignedInt()
  external int tv_sec;
...
class snd_seq_timestamp extends ffi.Union {
  @snd_seq_tick_time_t()
  external int tick;
...
class snd_seq_ev_note extends ffi.Struct {
  @ffi.UnsignedChar()
...
class snd_seq_ev_ctrl extends ffi.Struct {
  @ffi.UnsignedChar()
  external int channel;
...
class snd_seq_ev_raw8 extends ffi.Struct {
  @ffi.Array.multi([12])
  external ffi.Array<ffi.UnsignedChar> d;
}

class snd_seq_ev_raw32 extends ffi.Struct {
  @ffi.Array.multi([3])
...
class snd_seq_result extends ffi.Struct {
  @ffi.Int()
  external int event;
...
class snd_seq_queue_skew extends ffi.Struct {
  @ffi.UnsignedInt()
  external int value;
...
class snd_seq_ev_queue_control extends ffi.Struct {
  @ffi.UnsignedChar()
  external int queue;
...
class snd_seq_event extends ffi.Struct {
...
const int SND_LIB_SUBMINOR = 2;

const int SND_LIB_EXTRAVER = 1000000;

const int SND_LIB_VERSION = 66050;

const String SND_LIB_VERSION_STR = '1.2.2';
